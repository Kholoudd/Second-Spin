...
class Recycle_Product_Details extends StatefulWidget {
  ...
  const Recycle_Product_Details({super.key});
  @override
  State<Recycle_Product_Details> createState() =>
      _Recycle_Product_DetailsState();
}
...
class _Recycle_Product_DetailsState extends State<Recycle_Product_Details> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: recylePVM.prodcuctData == null
          ? const Center(
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  padding:
                                      EdgeInsets.all(mediaquery.width * 0.02),
                                  decoration: BoxDecoration(
                                      color: Colors.white,
                                      borderRadius: BorderRadius.circular(20)),
                                  child: GestureDetector(
                                      onTap: () async {
                                        if (recylePVM.prodcuctData?.isfav ==
                                            false) {
                          ...
                          Padding(
                            padding: EdgeInsets.symmetric(
                                vertical: mediaquery.width * 0.0),
                            child: Text(recylePVM.prodcuctData?.title ?? "",
                                style: theme.textTheme.bodyLarge),
                          ),
                          Text(recylePVM.prodcuctData?.description ?? "",
