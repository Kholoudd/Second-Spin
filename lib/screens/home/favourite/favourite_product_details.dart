...
class Favourite_product_details extends StatefulWidget {
  ...
  const Favourite_product_details({super.key});

  @override
  State<Favourite_product_details> createState() =>
      _Favourite_product_detailsState();
}
          ...
          : Container(
              ...
              child: SingleChildScrollView(
                child: Column(children: [
                  ...
                  Text(favPVM.prodcuctData?.description ?? "",
                      style: theme.textTheme.bodyMedium!
                          .copyWith(color: const Color(0xffA7A7A7))),
                  Text(favPVM.prodcuctData?.location ?? "",
                      style: theme.textTheme.bodyMedium),
                  Container(
